...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the school basketball team for practice and games",
    ...
    "Swimming Club": {
        ...
        "max_participants": 20,
        "participants": ["nina@mergington.edu", "harry@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Drama Society": {
        "description": "Prepare scenes and performances for school theater productions",
    ...
    "Debate Club": {
        "description": "Practice public speaking and structured debate skills",
